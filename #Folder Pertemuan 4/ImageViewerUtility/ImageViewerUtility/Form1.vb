...
Public Class Form1
    ...
    Private Sub GetFiles(ByVal PathName As String)
        ...
        For Each nFile As String In Directory.GetFiles(PathName)
            ...
            If (Trim(sExtension) = ".bmp" Or Trim(sExtension) = ".jpg" Or Trim(sExtension) = ".jpeg" Or Trim(sExtension) = ".gif" Or Trim(sExtension) = ".png") Then
    ...
    Private Sub tvDrive_BeforeExpand(sender As Object, e As System.Windows.Forms.TreeViewCancelEventArgs) Handles tvDrive.BeforeExpand
        GetFolders(e.Node)
    End Sub
